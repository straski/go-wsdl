build:
	env GOOS=windows GOARCH=amd64 go build -ldflags "-w" -o bin/go-wsdl-win64 main.go
	env GOOS=windows GOARCH=386 go build -ldflags "-w" -o bin/go-wsdl-win32 main.go
